      ...
      {isLoading ? (
        ...
        <div>
            ...
            {stats?.map((stat) => (
              <div>
                {stat.title === "hp" ? (
                  <div>
                    <span>
                      {<img src={life} alt={"life"} className={styles.pic} />}
                    </span>
                    <span className={styles.titleNew}>
                ...
                {stat.title === "speed" ? (
                  <div>
                    <span>
                      {<img src={speed} alt={"speed"} className={styles.pic} />}
                    </span>
                    <span className={styles.titleNew}>
                      {stat.title} - {stat.value}
                    </span>
          ...
          <div className={styles.button}>
            {isPokemonAddedToCard(name) ? (
              <div className={styles.added}>Already In Cart</div>
            ) : (
              <Button
                style={{
                  backgroundColor: "#02524c",
                  color: "#FFFFFF",
                  marginBottom: "15px",
                }}
